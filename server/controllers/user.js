...
export const signup=async(req,res)=>{
    ...
    try {
        ...
        const result=await User.create({email:email,password:hashedPass,name:fullName});
        
        const token=jwt.sign({email:result.email, id:result.id},process.env.SECRET_KEY,{expiresIn:'1h'});
